                    ...
                    <Col md={10} className="mx-auto">
                        <Card className="border-0" style={{ background: 'linear-gradient(135deg, #f8f9fa 0%, #e9f2ff 100%)' }}>
                            <Card.Body className="p-4" id="application-form">
                                <div className="mb-4">
                                    <h6 className="text-success mb-2" style={{ fontWeight: '600' }}>APPLICATION PROCESS</h6>
                                    <h2 className="mb-3" style={{
                                        color: '#1a1a1a',
                                        fontWeight: '700',
                                        fontSize: '2rem'
                                        ...
                                        <span style={{ color: '#ff5722' }}>ICCR SCHOLARSHIP</span>
                                    </h2>
                                </div>
                                    ...
                                    <Row className="g-4">
                                        ...
                                        <Col md={12}>
                                            <Card className="border-0 shadow-sm mb-4">
                                                <Card.Body>
                                                    <h5 className="mb-4" style={{ color: '#1a1a1a', fontWeight: '600' }}>
                                                        <BookFill className="me-2 text-success" />
                                                        Academic Preferences
                                                    </h5>
                                                    <Form.Group className="mb-4">
                                                        <Form.Label className="fw-semibold">Preferred Course</Form.Label>
                                                        <Form.Select
                                                            name="course"
                                                        ...
                                                        >
                                                            ...
                                                            <option value="commerce">Commerce and Management</option>
                                                    ...
                                                    <h6 className="mb-3 fw-semibold">University Preferences</h6>
                                                    {[1, 2, 3, 4, 5].map((num, idx) => (
                                                        <Form.Group key={idx} className="mb-3">
                                                            <Form.Label className="text-muted">Preference {num}</Form.Label>
                                                            <Form.Control
                                                                type="text"
                                                                value={formData.universities[idx]}
                                                                onChange={(e) => handleUniversityChange(idx, e.target.value)}
                                                                placeholder={`Enter university preference ${num}`}
                                                                className="py-2"
                                                            />
                                                        </Form.Group>
                                                    ))}
                                        ...
                                        <Col md={12}>
                                            <Card className="border-0 shadow-sm mb-4">
                                                <Card.Body>
                                                    ...
                                                    <Form.Group className="mb-4">
                                                        <Form.Label className="fw-semibold">English Proficiency Essay (500 words)</Form.Label>
                                                        <Form.Control
                                                            as="textarea"
                                                            name="essay"
                                                    ...
                                                    <Form.Group>
                                                        <Form.Label className="fw-semibold">Upload Required Documents</Form.Label>
                                                        <Form.Control
                                                            type="file"
                                                            multiple
